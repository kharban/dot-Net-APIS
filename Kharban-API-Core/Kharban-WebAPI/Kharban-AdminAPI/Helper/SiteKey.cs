...
namespace Kharban_AdminAPI.Helper
{
    public class SiteKey
    {
        ...
        public static string AWSSecretKey => _configureAppSetting["AWSSecretKey"];
        public static string AWSAccessKey => _configureAppSetting["AWSAccessKey"];
